...
-(void)setToolBarHidden:(BOOL)hidden animation:(BOOL)animate{
    ...
    [allSelectedBtn setTitleColor:[UIColor colorddbb99] forState:UIControlStateNormal];
    ...
    [deleteBtn setTitleColor:[UIColor colorddbb99] forState:UIControlStateNormal];
...
-(void)createContents{
    ...
    _segmentCtl.backgroundColor = [UIColor colorddbb99];
    _segmentCtl.layer.cornerRadius = 2;
    _segmentCtl.layer.borderColor = [UIColor whiteColor].CGColor;
    _segmentCtl.layer.borderWidth = 1.0f;
//    [_segmentCtl setBackgroundImage:[UIColor imageWithColor:[UIColor groupTableViewBackgroundColor] ]
//                           forState:UIControlStateNormal barMetrics:UIBarMetricsDefault];
//    [_segmentCtl setBackgroundImage:[UIColor imageWithColor:[UIColor mainColor] ]
//                           forState:UIControlStateSelected barMetrics:UIBarMetricsDefault];
    ...
    [_segmentCtl setTitleTextAttributes:textColorDic forState:UIControlStateNormal];
    
    UIColor *selectTextColor = [UIColor colorddbb99];
    NSDictionary *selectTextColorDic = [NSDictionary dictionaryWithObject:selectTextColor forKey:NSForegroundColorAttributeName];
    [_segmentCtl setTitleTextAttributes:selectTextColorDic forState:UIControlStateSelected];
...
-(UIView *)createHeaderViewWithTable:(DownLoadingTableView *)tableView{
    ...
    if (tableView.isDownLoadCompletedTableView) {
        ...
        lookAllBtn.hidden = YES;
        tableHeaderView.frame = CGRectMake(0, 0, self.view.bounds.size.width, 0);
    }else{
    
        UIButton *allStartBtn = [UIButton new];
        [allStartBtn setTitle:@"全部开始" forState:UIControlStateNormal];
        [allStartBtn setTitleColor:[UIColor colorddbb99] forState:UIControlStateNormal];
        allStartBtn.backgroundColor = [UIColor groupTableViewBackgroundColor];
        ...
        [allStopBtn setTitleColor:[UIColor colorddbb99] forState:UIControlStateNormal];
        allStopBtn.backgroundColor = [UIColor groupTableViewBackgroundColor];
        ...
        [allStopBtn mas_makeConstraints:^(MASConstraintMaker *make) {
            make.right.top.equalTo(tableHeaderView);
            make.width.equalTo(tableHeaderView).multipliedBy(0.48);
        }];
    }
