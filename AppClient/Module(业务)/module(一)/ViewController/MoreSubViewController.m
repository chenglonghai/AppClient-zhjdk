...
@interface MoreSubViewController ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation MoreSubViewController
...
- (void)requestDataWithSumNum:(NSString *)sumNum pageNum:(NSString *)pageNum{
    ...
    NSDictionary *dict = @{@"sumNum":sumNum,@"pageNum":pageNum,@"pageSize":@"10",@"stage":self.stage};
